...
{
	m_contract->comboLegs = &m_comboLegs;
	...
	m_secIdType = _T( "" );
	m_secId = _T( "" );
	m_genericTicks = _T( "mdoff,100,101,104,105,106,107,165,221,225,233,236,258" );
...
void CDlgOrder::DoDataExchange( CDataExchange* pDX )
{
	...
	DDX_Text( pDX, IDC_EDIT_ORDER_PRICE, m_lmtPrice );
	DDX_Text( pDX, IDC_EDIT_ORDER_AUX_PRICE, m_auxPrice );
